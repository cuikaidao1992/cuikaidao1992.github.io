$(function () {
    ...
    function n() {
        ...
        $(".page-tabs-content a").each(function(index){
        ...
        if ($(".J_menuTab").each(function () {
            ...
            var r = '<iframe class="J_iframe" onload="this.height=iframe'+ a +'.document.body.scrollHeight"  name="iframe' + a + '" width="100%" height="1000px" src="' + t + '?v=4.0" frameborder="0" data-id="' + t + '" seamless></iframe>';
