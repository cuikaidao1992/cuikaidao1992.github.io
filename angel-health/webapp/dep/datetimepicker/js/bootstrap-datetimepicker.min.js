    ...
    function(t) {
        ...
        var i = function(e, i) {
            ...
            this.element = t(e),
                ...
                this.format = o.parseFormat(i.format || this.element.data("date-format") || n[this.language].format || o.getDefaultFormat(this.formatType, "input"), this.formatType),
                this.isInline = !1,
                this.isVisible = !1,
            ...
            this.component && 0 === this.component.length && (this.component = !1),
                ...
                this.linkFormat = o.parseFormat(i.linkFormat || this.element.data("link-format") || o.getDefaultFormat(this.formatType, "link"), this.formatType),
                ...
                this.picker = t(o.template).appendTo(this.isInline ? this.element: "body").on({
            ...
            this.isRTL && (this.picker.addClass("datetimepicker-rtl"), this.picker.find(".prev i, .next i").toggleClass("fa fa-arrow-left fa fa-arrow-right")),
        ...
        i.prototype = {
            ...
            getFormattedDate: function(t) {
                return void 0 == t && (t = this.format),
                    o.formatDate(this.date, t, this.language, this.formatType)
            },
            setStartDate: function(t) {
                this.startDate = t || -1 / 0,
                this.startDate !== -1 / 0 && (this.startDate = o.parseDate(this.startDate, this.format, this.language, this.formatType)),
                    this.update(),
                    this.updateNavArrows()
            },
            setEndDate: function(t) {
                this.endDate = t || 1 / 0,
                1 / 0 !== this.endDate && (this.endDate = o.parseDate(this.endDate, this.format, this.language, this.formatType)),
                    this.update(),
                    this.updateNavArrows()
            },
            ...
            update: function() {
                ...
                t || (t = new Date, e = !1),
                    this.date = o.parseDate(t, this.format, this.language, this.formatType),
                e && this.setValue(),
            ...
            fill: function() {
                if (null != this.date && null != this.viewDate) {
                    var i = new Date(this.viewDate),
                        ...
                        d = 1 / 0 !== this.endDate ? this.endDate.getUTCFullYear() : 1 / 0,
                        f = 1 / 0 !== this.endDate ? this.endDate.getUTCMonth() : 1 / 0,
                        g = new e(this.date.getUTCFullYear(), this.date.getUTCMonth(), this.date.getUTCDate()).valueOf(),
                        p = new Date;
                    if (this.picker.find(".datetimepicker-days thead th:eq(1)").text(n[this.language].months[r] + " " + a), "time" == this.formatViewType) {
                        var _ = c % 12 ? c % 12 : 12,
                            b = (10 > _ ? "0": "") + _,
                            m = (10 > l ? "0": "") + l,
                            v = n[this.language].meridiem[12 > c ? 0 : 1];
                        this.picker.find(".datetimepicker-hours thead th:eq(1)").text(b + ":" + m + " " + v.toUpperCase()),
                            this.picker.find(".datetimepicker-minutes thead th:eq(1)").text(b + ":" + m + " " + v.toUpperCase())
                    } else this.picker.find(".datetimepicker-hours thead th:eq(1)").text(s + " " + n[this.language].months[r] + " " + a),
                        this.picker.find(".datetimepicker-minutes thead th:eq(1)").text(s + " " + n[this.language].months[r] + " " + a);
                    this.picker.find("tfoot th.today").text(n[this.language].today).toggle(this.todayBtn !== !1),
                        this.updateNavArrows(),
                        this.fillMonths();
                    var w = e(a, r - 1, 28, 0, 0, 0, 0),
                        y = o.getDaysInMonth(w.getUTCFullYear(), w.getUTCMonth());
                    w.setUTCDate(y),
                        w.setUTCDate(y - (w.getUTCDay() - this.weekStart + 7) % 7);
                    var x = new Date(w);
                    x.setUTCDate(x.getUTCDate() + 42),
                        x = x.valueOf();
                    for (var k, C = []; w.valueOf() < x;) w.getUTCDay() == this.weekStart && C.push("<tr>"),
                        k = "",
                        w.getUTCFullYear() < a || w.getUTCFullYear() == a && w.getUTCMonth() < r ? k += " old": (w.getUTCFullYear() > a || w.getUTCFullYear() == a && w.getUTCMonth() > r) && (k += " new"),
                    this.todayHighlight && w.getUTCFullYear() == p.getFullYear() && w.getUTCMonth() == p.getMonth() && w.getUTCDate() == p.getDate() && (k += " today"),
                    w.valueOf() == g && (k += " active"),
                    (w.valueOf() + 864e5 <= this.startDate || w.valueOf() > this.endDate || -1 !== t.inArray(w.getUTCDay(), this.daysOfWeekDisabled)) && (k += " disabled"),
                        C.push('<td class="day' + k + '">' + w.getUTCDate() + "</td>"),
                    w.getUTCDay() == this.weekEnd && C.push("</tr>"),
                        w.setUTCDate(w.getUTCDate() + 1);
                    this.picker.find(".datetimepicker-days tbody").empty().append(C.join("")),
                        C = [];
                    for (var A = "",
                             T = "",
                             D = "",
                    ...
                    for (var B = 0; 60 > B; B += this.minuteStep) {
                        var E = e(a, r, s, c, B, 0);
                        k = "",
                            E.valueOf() < this.startDate || E.valueOf() > this.endDate ? k += " disabled": Math.floor(l / this.minuteStep) == Math.floor(B / this.minuteStep) && (k += " active"),
                            this.showMeridian && 2 == n[this.language].meridiem.length ? (T = 12 > c ? n[this.language].meridiem[0] : n[this.language].meridiem[1], T != D && ("" != D && C.push("</fieldset>"), C.push('<fieldset class="minute"><legend>' + T.toUpperCase() + "</legend>")), D = T, A = c % 12 ? c % 12 : 12, C.push('<span class="minute' + k + '">' + A + ":" + (10 > B ? "0" + B: B) + "</span>"), 59 == B && C.push("</fieldset>")) : (A = B + ":00", C.push('<span class="minute' + k + '">' + c + ":" + (10 > B ? "0" + B: B) + "</span>"))
                    }
                    ...
                    S == a && j.eq(this.date.getUTCMonth()).addClass("active"),
                    (h > a || a > d) && j.addClass("disabled"),
                    a == h && j.slice(0, u).addClass("disabled"),
                    a == d && j.slice(f + 1).addClass("disabled"),
                        C = "",
                        a = 10 * parseInt(a / 10, 10);
                    var F = this.picker.find(".datetimepicker-years").find("th:eq(1)").text(a + "-" + (a + 9)).end().find("td");
                    a -= 1;
                    for (var B = -1; 11 > B; B++) C += '<span class="year' + ( - 1 == B || 10 == B ? " old": "") + (S == a ? " active": "") + (h > a || a > d ? " disabled": "") + '">' + a + "</span>",
                        a += 1;
                    F.html(C),
                        this.place()
                }
                ...
                switch (this.viewMode) {
                    case 0:
                        this.startDate !== -1 / 0 && e <= this.startDate.getUTCFullYear() && i <= this.startDate.getUTCMonth() && n <= this.startDate.getUTCDate() && o <= this.startDate.getUTCHours() ? this.picker.find(".prev").css({
                            ...
                            1 / 0 !== this.endDate && e >= this.endDate.getUTCFullYear() && i >= this.endDate.getUTCMonth() && n >= this.endDate.getUTCDate() && o >= this.endDate.getUTCHours() ? this.picker.find(".next").css({
                                visibility: "hidden"
            ...
            mousewheel: function(e) {
                if (e.preventDefault(), e.stopPropagation(), !this.wheelPause) {
                    ...
                    var i = e.originalEvent,
                        n = i.wheelDelta,
                        o = n > 0 ? 1 : 0 === n ? 0 : -1;
                    this.wheelViewModeNavigationInverseDirection && (o = -o),
                        this.showMode(o),
                    ...
                    switch (n[0].nodeName.toLowerCase()) {
                        case "th":
                            switch (n[0].className) {
                                ...
                                case "today":
                                    var r = new Date;
                                    r = e(r.getFullYear(), r.getMonth(), r.getDate(), r.getHours(), r.getMinutes(), r.getSeconds(), 0),
                                        this.viewMode = this.startViewMode,
                                        this.showMode(0),
                                        this._setDate(r),
                                        this.fill(),
                        ...
                        case "td":
                            if (n.is(".day") && !n.is(".disabled")) {
                                var l = parseInt(n.text(), 10) || 1,
                                    ...
                                    u = this.viewDate.getUTCMinutes(),
                                    d = this.viewDate.getUTCSeconds();
                                n.is(".old") ? 0 === c ? (c = 11, s -= 1) : c -= 1 : n.is(".new") && (11 == c ? (c = 0, s += 1) : c += 1),
            ...
            showMode: function(t) {
                ...
                this.picker.find(">div").hide().filter(".datetimepicker-" + o.modes[this.viewMode].clsName).css("display", "block"),
                    this.updateNavArrows()
            },
            reset: function() {
                ...
                return n.shift(),
                    this.each(function() {
                        var o = t(this),
                            ...
                            r = "object" == typeof e && e;
                        a || o.data("datetimepicker", a = new i(this, t.extend({},
                            t.fn.datetimepicker.defaults, r))),
        ...
        var n = t.fn.datetimepicker.dates = {
            ...
            o = {
                ...
                parseDate: function(o, a, r, s) {
                    ...
                    var g, p, l, d = o && o.match(this.nonpunctuation) || [],
                        o = new Date(0, 0, 0, 0, 0, 0, 0),
                        _ = {},
                        b = ["hh", "h", "ii", "i", "ss", "s", "yyyy", "yy", "M", "MM", "m", "mm", "D", "DD", "d", "dd", "H", "HH", "p", "P"],
                        m = {
                            hh: function(t, e) {
                    ...
                    if (m.M = m.MM = m.mm = m.m, m.dd = m.d, m.P = m.p, o = e(o.getFullYear(), o.getMonth(), o.getDate(), o.getHours(), o.getMinutes(), o.getSeconds()), d.length == a.parts.length) {
                        ...
                        for (var w, f = 0; f < b.length; f++) w = b[f],
                        w in _ && !isNaN(_[w]) && m[w](o, _[w])
                    }
                    return o
                },
                formatDate: function(e, i, a, r) {
                    ...
                    if ("standard" == r) s = {
                        ...
                        s = {
                            ...
                            s.m = (s.n < 10 ? "0": "") + s.n,
                            s.d = (s.j < 10 ? "0": "") + s.j,
                            s.A = s.a.toString().toUpperCase(),
                            s.h = (s.g < 10 ? "0": "") + s.g,
                            s.H = (s.G < 10 ? "0": "") + s.G,
                            s.i = (s.i < 10 ? "0": "") + s.i,
                            s.s = (s.s < 10 ? "0": "") + s.s
                    }
                    for (var e = [], c = t.extend([], i.separators), l = 0, h = i.parts.length; h > l; l++) c.length && e.push(c.shift()),
                        e.push(s[i.parts[l]]);
                    return e.join("")
                },
        ...
        o.template = '<div class="datetimepicker"><div class="datetimepicker-minutes"><table class=" table-condensed">' + o.headTemplate + o.contTemplate + o.footTemplate + "</table>" + "</div>" + '<div class="datetimepicker-hours">' + '<table class=" table-condensed">' + o.headTemplate + o.contTemplate + o.footTemplate + "</table>" + "</div>" + '<div class="datetimepicker-days">' + '<table class=" table-condensed">' + o.headTemplate + "<tbody></tbody>" + o.footTemplate + "</table>" + "</div>" + '<div class="datetimepicker-months">' + '<table class="table-condensed">' + o.headTemplate + o.contTemplate + o.footTemplate + "</table>" + "</div>" + '<div class="datetimepicker-years">' + '<table class="table-condensed">' + o.headTemplate + o.contTemplate + o.footTemplate + "</table>" + "</div>" + "</div>",
            t.fn.datetimepicker.DPGlobal = o,
