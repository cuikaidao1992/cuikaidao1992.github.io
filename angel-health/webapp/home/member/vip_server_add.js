	...
	var table2 = $('#table2').dataTable({
				...
				"aoColumns" : [
					{"mDataProp" : "id","bSortable": false,'sClass': "text-center","mRender": function ( data, type, full ) {
						return '<label onclick="yy('+data+')" class="labletab" style="padding-top: 0px"> <input name="ajaxradio" type="radio" class="radio_1" onClick=""> <span class="text" checked></span> </label>';
		              }},
