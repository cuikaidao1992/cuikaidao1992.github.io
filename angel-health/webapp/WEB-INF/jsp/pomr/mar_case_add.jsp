				...
				<div class="col-xs-12 col-md-12 col-lg-12">
					<div class="widget">
						<div class="widget-header ">
							<span class="widget-caption">新增电子病历记录</span>
						...
						<div class="widget-body" style="overflow: hidden">
							<div class="col-lg-12 col-lg-12 col-xs-12 ">
								<form class="form-horizontal form-bordered" role="form" action="${ctx }/cpr/save" method="post"
									id="mar_case" enctype="multipart/form-data">
									<div class="widget">
										<div class="bancgud">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
														...
														placeholder="会员名称" name="customerNameCheck" data-bv-notempty="true"
														data-bv-notempty-message="用户不能为空" value="" id="click_customer"> <input
														type="hidden" name="customerId" id="customerId" value="" />
													...
													<div>
														<div class="input-group">
															<input class="form-control date-picker"
																...
																data-date-format="yyyy-mm-dd" value="" name="recordTime" >
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input class="form-control" type="text" id="starttime"
														placeholder="请输入科室" name="department" data-bv-notempty="true"
													...
													<div class="tabbable">
														...
														<div class="tab-content" style="overflow: hidden;">
															<div id="home5" class="tab-pane in active">
																<textarea class="col-md-12  h_textarea" name="hpi" placeholder="请输入病例史描述"></textarea>
															</div>

															<div id="profile5" class="tab-pane">
																<textarea class="col-md-12 h_textarea" name="clinical" placeholder="请输入临床表现描述"></textarea>
															</div>

															<div id="dropdown5" class="tab-pane">
																<textarea class="col-md-12 h_textarea" name="assistCheck" placeholder="请输入辅助检查描述"></textarea>
															</div>

															<div id="dropdown4" class="tab-pane">
																<textarea class="col-md-12 h_textarea" name="specialCheck" placeholder="请输入特殊描述"></textarea>
															</div>
															<div id="dropdown3" class="tab-pane">
																<textarea class="col-md-12 h_textarea" name="diagnosis" placeholder="请输入诊断描述"></textarea>
															</div>
															<div id="dropdown2" class="tab-pane">
																<textarea class="col-md-12 h_textarea" name="treatment" placeholder="请输入治疗描述"></textarea>
															</div>
															<div id="dropdown1" class="tab-pane">
																<textarea class="col-md-12 h_textarea" name="surgery" placeholder="请输入病例史描述"></textarea>
															</div>
														</div>
													</div>
												</div>
