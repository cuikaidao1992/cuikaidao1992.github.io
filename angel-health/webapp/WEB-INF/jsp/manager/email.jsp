											...
											<table class="table table-striped table-hover table-bordered" id="bodyHtml">
												<thead>
													<tr role="row">
														...
														<th>
															邮件标题 <span class="fa indicator fa-unsorted"></span>
														</th>
														<th>
												...
												<tbody>
													<tr>
														...
														<td><input type="text" class="six" value="祝福邮件" disabled="disabled"></td>
														<td>
										...
										<div id="profile" class="tab-pane">
											...
											<form id="registrationForm" method="post" class="form-horizontal">
												...
												<div class="form-group">
													<label class="col-lg-4 control-label">邮件标题<span class="help-inline"><font color="red">*</font></span></label>
													<div class="col-lg-8">
														<input type="text" class="form-control" name="msgName" data-bv-notempty="true" data-bv-notempty-message="邮件标题不能为空" />
													</div>
												</div>
												
												<div class="form-group">
													<label class="col-lg-4 control-label">邮件类型</label>
													<div class="col-lg-8">
														<select class="form-control" name="msgType">
															<option value="1" selected="selected">祝福邮件</option>
															<option value="2">系统通知邮件</option>
															<option value="3">活动通知邮件</option>
														</select>
													</div>
												</div>
												...
												<div class="form-group">
													<label class="col-lg-4 control-label">邮件内容</label>
													<div class="col-lg-8">
										...
										<div id="editDepart" class="tab-pane">
											...
											<form id="editForm" method="post" class="form-horizontal">
												<div class="form-group">
													<label class="col-lg-4 control-label">邮件标题<span class="help-inline"><font color="red">*</font></span></label>
													<div class="col-lg-8">
														<input type="text" value="生日快乐" class="form-control" name="msgName" data-bv-notempty="true" data-bv-notempty-message="邮件标题不能为空" />
													</div>
												</div>
												...
												<div class="form-group" id="sendType">
													<label class="col-lg-4 control-label">发送类型</label>
													<div class="col-lg-8">
														<select type="text" class="form-control" name="sendType" disabled="true">
												...
												<div class="form-group" id="sendTime">
													<label class="col-lg-4 control-label">发送时间</label>
													<div class="col-lg-8">
														<div class="input-group" style="width: 80%;">
			                                                <input value="2016-09-16 15:30:20" style="width: 100%;" class="form-control date-picker" id="id-date-picker-1" type="text" data-date-format="dd-mm-yyyy">
			                                                <span class="input-group-addon">
			                                                    <i class="fa fa-calendar"></i>
			                                                </span>
			                                            </div>
