                      ...
                      <div class="row">
                        <div class="col-xs-12 col-md-12">
                            <div class="widget">
                                ...
                                <input type="hidden" id="lookoredit" value="${method }">
                                        ...
                                        <div class="widget">
                                            <div class=" bancgud" >
                                            	 ...
                                            	 <div class="formfont">基础信息</div>
                                            	  <form class="form-horizontal" role="form" id="dicForm" method="post" onsubmit="return userformedit()">
                                            	  <input type="hidden" name="id" value="${dict.id }">
                                                    <div class="form-group">
                                                        <label for="inputEmail3" class="col-sm-2 control-label no-padding-right">键&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;值<span class="help-inline"><font color="red">*</font> </span></label>
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control" id="inputEmail3" placeholder="请输入键值" name="value" data-bv-notempty="true" data-bv-notempty-message="键值为必填项，不能为空" value="${dict.value }" disabled="disabled">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="inputPassword3" class="col-sm-2 control-label no-padding-right">标&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;签</label>
                                                        <div  class="col-sm-8">
                                                            <input type="text" class="form-control fl " name="label"  placeholder="请输入标签内容" value="${dict.label }" disabled="disabled">
                                                        </div>
                                                    </div>
                                                    
                                         
                                                    <div class="form-group">
                                                        <label for="inputPassword3" class="col-sm-2 control-label no-padding-right">类&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;型</label>
                                                        <div  class="col-sm-8">
                                                            <input type="text" class="form-control fl " name="type"  placeholder="请输入类型内容" value="${dict.type }" disabled="disabled" >
                                                        </div>
                                                    </div>
                                                    													
 
                                                    <div class="form-group">
                                                        <label for="inputPassword3" class="col-sm-2 control-label no-padding-right">描&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;述</label>
                                                        <div  class="col-sm-8">
                                                            <input type="text" class="form-control fl " name="description" placeholder="请输入描述内容" value="${dict.description }" disabled="disabled">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="inputPassword3" class="col-sm-2 control-label no-padding-right">排&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;序</label>
                                                        <div  class="col-sm-8">
                                                            <input type="text" class="form-control fl " name="sort" placeholder="请输入标签内容" value="${dict.sort }" disabled="disabled">
                                                        </div>
                                                    </div>
                                                     <div class="form-group">
                                                        <label for="inputPassword3" class="col-sm-2 control-label no-padding-right">备&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注</label>
                                                        <div  class="col-sm-8">
                                                            <textarea name="remarks" disabled="disabled" >${dict.remarks }</textarea>
                                                        </div>
                                                    </div>
                                             ...
                                             <div class="col-sm-8 col-xs-offset-3 btn-bottm" style="padding-top:25px">
		                                          <button id="tagIdSubmitAddVip_btn" type="submit" class="btn btn-darkorange  col-sm-2 col-xs-offset-4" href="#closeCourse" data-toggle="modal">返回</button>
		                                       </div>
                                        </div>
  ...
  <script type="text/javascript">
   ...
   <script type="text/javascript">
     ...
     window.onload=function(){
    	 var method = $("#lookoredit").val();
		if(method == "2"){
			$("input").removeAttr("disabled");
			$("textarea").removeAttr("disabled");
			$("select").removeAttr("disabled");
			$("#tagIdSubmitAddVip_btn").html("提交");
		}
     }
    function userformedit(){
    	var value = $("#inputEmail3").val().trim();
		if (!value) {
			alert("请输入键值！");
			return false;
		}
		$.ajax({
			url : "${ctx}/manager/dict/update",
			type : "POST",
