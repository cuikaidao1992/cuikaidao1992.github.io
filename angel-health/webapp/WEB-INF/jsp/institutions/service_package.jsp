									...
									<div class="widget-body">
										...
										<div id="home" class="tab-pane in active">
											<div class="table-toolbar">
												...
												<a class="btn btn-blue col-padd" href="${ctx}/servicePackages/toAddServicePackage">
													<i class="fa fa-plus"></i>新增服务套餐
												</a>
											...
											<table class="table table-striped table-hover table-bordered" id="bodyHtml">
												<thead>
													<tr>
														...
														<th>
															服务套餐编号 <span class="fa indicator fa-unsorted"></span>
														</th>
														<th>
															服务套餐名称 <span class="fa indicator fa-unsorted"></span>
														</th>
														<th>
															服务套餐周期（月） <span class="fa indicator fa-unsorted"></span>
														</th>
														<th>
															服务套餐价格 <span class="fa indicator fa-unsorted"></span>
														</th>
														<th>
															服务套餐描述 <span class="fa indicator fa-unsorted"></span>
														</th>
														<th width="20%">
												...
												<c:forEach items="${pager.list}" var="fr">
													<tr>
														...
														<td>
															<a href="#" class="btn btn-info btn-xs editClass">修改</a>
															<a href="#" class="btn btn-danger btn-xs re	moveClass"><i class="fa fa-trash-o"></i> 删除</a>
														</td>
													</tr>
												  </c:forEach>	
