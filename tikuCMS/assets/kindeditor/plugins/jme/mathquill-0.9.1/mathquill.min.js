 ...
 */(function () {
    ...
    function at(t, r, i, s) {
        ...
        if (!s) {
            h = n(a, {container: t}), t.bind("cut paste", !1).bind("copy", d).prepend('<span class="selectable">$' + r.latex() + "$</span>"), a.blur(function () {
    ...
    function ft(e, n, r) {
        return t(B, {ctrlSeq: e, htmlTemplate: "<" + n + " " + r + ">&0</" + n + ">"})
    }

    var e, t, n, r, i, s, o, u, a, f, l, c, h, p, d, v, m, g, y, b, w, E, S, x, T, N, C, k, L, A, O, M, _, D, P, H, B,
        j, F, I, q, R, U, z, W, X, V, $, J, K, Q, G, Y, Z = jQuery, et = "mathquill-command-id",
        tt = "mathquill-block-id", nt = Math.min, rt = Math.max, it = [].slice;
    t = function (e, t, n) {
        function r(e) {
        ...
        function s(s, o) {
            ...
            o === n && (o = s, s = Object);
            var a = u[e] = new s, f = s[e], l, c = u.mixin = function (e) {
                l = {}, i(e) ? l = e.call(u, a, f, u, s) : r(e) && (l = e);
                if (r(l))for (var n in l)t.call(l, n) && (a[n] = l[n]);
        ...
        function n(e) {
            var n = e.which || e.keyCode, r = t[n], i, s = [];
            return e.ctrlKey && s.push("Ctrl"), e.originalEvent && e.originalEvent.metaKey && s.push("Meta"), e.altKey && s.push("Alt"), e.shiftKey && s.push("Shift"), i = r || String.fromCharCode(n), !s.length && !r ? i : (s.push(i), s.join("-"))
        }
        ...
        return function (r, i) {
            ...
            function m() {
                p && (clearTimeout(p), p = e, d())
            }

            function g(e) {
                m(), c.val(e), e && c[0].select()
            }
            ...
            var s = null, o = null;
            i || (i = {});
            var u = i.text || st, a = i.key || st, f = i.paste || st, l = i.cut || st, c = Z(r),
                h = Z(i.container || c), p, d;
            return h.bind("keydown keypress input keyup focusout paste", m), h.bind({
                keydown: E,
                keypress: S,
                focusout: x,
                cut: l,
        ...
        var i = this.string = function (e) {
            ...
            }, a = n.letter = s(/^[a-z]/i), f = n.letters = s(/^[a-z]*/i), l = n.digit = s(/^[0-9]/),
            c = n.digits = s(/^[0-9]*/), h = n.whitespace = s(/^\s+/), p = n.optWhitespace = s(/^\s*/),
        ...
        e.first = 0, e.last = 0, e.init = function (e, t) {
            ...
            var e = this, n = e.first;
            if (!n || e.disowned)return e;
            e.disowned = !0;
            var r = e.last, i = n.parent;
            ...
            var t = this, n = t.first;
            if (!n)return t;
            for (; n !== t.last.next; n = n.next)if (e.call(t, n) === !1)break;
            return t
        }, e.fold = function (e, t) {
        ...
        e.init = function (e) {
            ...
            return t.find("*").andSelf().each(function () {
                var e = Z(this), t = e.attr("mathquill-command-id"), n = e.attr("mathquill-block-id");
        ...
        e.init = function (e, n, r) {
            ...
            var t = this, n = t.replacedFragment;
            ...
            var e = this, t = e.numBlocks(), n = e.blocks = Array(t);
            for (var r = 0; r < t; r += 1) {
                var i = n[r] = l();
            ...
            var e = this, t = e.blocks, n = " mathquill-command-id=" + e.id,
                r = e.htmlTemplate.match(/<[^<>]+>|[^<>]+/g);
            ut("no unmatched angle brackets", r.join("") === this.htmlTemplate);
            for (var i = 0,
                     s = r[0]; s; i += 1, s = r[i])if (s.slice(-2) === "/>") r[i] = s.slice(0, -2) + n + "/>"; else if (s.charAt(0) === "<") {
    ...
    S ? g = function (e, t, n) {
        ...
        e.init = function (e, n, r) {
            ...
            if (this.respaced) {
                var e = +this.jQ.css("fontSize").slice(0, -2), t = this.prev.jQ.outerWidth(), n = this.jQ.outerWidth();
                this.jQ.css({
        ...
        e.init = function (e, n, r, i) {
            ...
            var e = this.firstChild.jQ, t = e.outerHeight() / +e.css("fontSize").slice(0, -2);
            g(this.bracketjQs, nt(1 + .2 * (t - 1), 1.2), 1.05 * t)
        }
    }), m.left = t(a, function (e) {
        e.parser = function () {
            var e, t, n, i = r.regex, s = r.string;
        ...
        e.ctrlSeq = "\\text", e.htmlTemplate = '<span class="text">&0</span>', e.replaces = function (e) {
            ...
            var e = r.string, t = r.regex, n = r.optWhitespace;
            ...
            if (this.replacedText)for (var n = 0; n < this.replacedText.length; n += 1)this.write(this.replacedText.charAt(n))
        }, e.write = function (e) {
            ...
            if (e !== "$") this.write(e); else if (this.isEmpty()) this.cursor.insertAfter(this).backspace().insertNew(z("\\$", "$")); else if (!this.cursor.next) this.cursor.insertAfter(this); else if (!this.cursor.prev) this.cursor.insertBefore(this); else {
        ...
        e.blur = function () {
            ...
            if (e.next.ctrlSeq === e.ctrlSeq) {
                var n = this, r = e.cursor, i = e.next.firstChild;
        ...
        e.ctrlSeq = "\\binom", e.htmlTemplate = '<span class="paren scaled">(</span><span class="non-leaf"><span class="array non-leaf"><span>&0</span><span>&1</span></span></span><span class="paren scaled">)</span>', e.textTemplate = ["choose(", ",", ")"], e.redraw = function () {
            var e = this.jQ.eq(1), t = e.outerHeight() / +e.css("fontSize").slice(0, -2), n = this.jQ.filter(".paren");
    ...
    }), m["+"] = ot($, "+", "+"), m["–"] = m["-"] = ot($, "-", "&minus;"), m["±"] = m.pm = m.plusmn = m.plusminus = ot($, "\\pm ", "&plusmn;"), m.mp = m.mnplus = m.minusplus = ot($, "\\mp ", "&#8723;"), v["*"] = m.sdot = m.cdot = ot(V, "\\cdot ", "&middot;"), m["="] = ot(V, "=", "="
    ), m["<"] = ot(V, "<", "&lt;"), m[">"] = ot(V, ">", "&gt;"), m.notin = m.sim = m.cong = m.equiv = m.oplus = m.otimes = t(V, function (e, t) {
        e.init = function (e) {
            t.init.call(this, "\\" + e + " ", "&" + e + ";")
        }
    ...
    }),m.ln = m.lg = m.log = m.span = m.proj = m.det = m.dim = m.min = m.max = m.mod = m.lcm = m.gcd = m.gcf = m.hcf = m.lim = K,function () {
        ...
        var n = r.string, i = r.regex, s = r.letter, o = r.any, u = r.optWhitespace, a = r.succeed, f = r.fail,
            c = s.map(U), h = i(/^[^${}\\_^]/).map(z),
            p = i(/^[^\\]/).or(n("\\").then(i(/^[a-z]+/i).or(i(/^\s+/).result(" ")).or(o))).then(function (e) {
                var t = m[e];
                return t ? t(e).parser() : f("unknown command: \\" + e)
            }), d = p.or(c).or(h), v = n("{").then(function () {
                return y
            }).skip(n("}")), g = u.then(v.or(d.map(e))), y = g.many().map(t).skip(u), b = n("[").then(g.then(function (e) {
                return e.join("latex") !== "]" ? a(e) : f()
            }).many().map(t).skip(u)).skip(n("]")), w = y;
        return w.block = g, w.optBlock = b, w
    }(),G = t(function (e) {
        function t(e, t) {
            if (e.next[t]) e.prependTo(e.next[t]); else if (e.prev[t]) e.appendTo(e.prev[t]); else {
                var r = e.parent;
                do {
                    var i = r[t];
                    if (i) {
                        ...
                        if (i === !1 || i instanceof l) {
                            e.upDownCache[r.id] = {parent: e.parent, prev: e.prev, next: e.next};
                            if (i instanceof l) {
                                var s = e.upDownCache[i.id];
                                if (s) s.next ? e.insertBefore(s.next) : e.appendTo(s.parent); else {
                                    var o = n(e).left;
        ...
        e.init = function (e) {
            ...
            if (this.prev) this.prev.lastChild ? this.appendTo(this.prev.lastChild) : this.hopLeft(); else {
            ...
            if (this.next) this.next.firstChild ? this.prependTo(this.next.firstChild) : this.hopRight(); else {
                if (this.parent === e)return;
            ...
            var n = r.all, s = r.eof, o = Q.skip(s).or(n.result(!1)).parse(e);
            ...
            var e = this.parent.parent, t = e.parent, n = e.next, r = this, i = e.prev;
            ...
            if (!this.next)if (this.prev) this.next = this.prev.next; else while (!this.next) {
            ...
            i(this), this.show();
            if (!this.deleteSelection())if (this.prev) this.prev.isEmpty() ? this.prev = this.prev.remove().prev : this.selectLeft(); else if (this.parent !== this.root) {
            ...
            i(this), this.show();
            if (!this.deleteSelection())if (this.next) this.next.isEmpty() ? this.next = this.next.remove().next : this.selectRight(); else if (this.parent !== this.root) {
            ...
            var t = this, n = e;
            e:for (; ;) {
                for (var r = this; r !== t.parent.parent; r = r.parent.parent)if (r.parent === n.parent) {
                    s = r, o = n;
                    break e
                }
                for (var i = e; i !== n.parent.parent; i = i.parent.parent)if (t.parent === i.parent) {
                    s = t, o = i;
                    break e
                }
            ...
            var s, o, u;
            if (s.next !== o) {
                for (var a = s; a; a = a.next)if (a === o.prev) {
                    u = !0;
                    break
                }
                u || (u = o, o = s, s = u)
            ...
            i(this);
            if (this.selection)if (this.selection.first === this.next) this.prev ? this.hopLeft().selection.extendLeft() : this.parent !== this.root && this.insertBefore(this.parent.parent).selection.levelUp(); else {
                this.hopLeft();
                ...
                if (this.prev) this.hopLeft(); else {
            ...
            i(this);
            if (this.selection)if (this.selection.last === this.prev) this.next ? this.hopRight().selection.extendRight() : this.parent !== this.root && this.insertAfter(this.parent.parent).selection.levelUp(); else {
                this.hopRight();
                if (this.selection.first === this.selection.last) {
                    this.clearSelection().show();
                    return
                ...
                if (this.next) this.hopRight(); else {
                    if (this.parent === this.root)return;
        ...
        e.init = function () {
            ...
            var e = this, t = e.first = e.last = e.last.parent.parent;
        ...
        switch (e) {
            ...
            case"html":
                console.log(this.html().replace(/ ?hasCursor|hasCursor /, "").replace(/ class=(""|(?= |>))/g, "").replace(/<span class="?cursor( blink)?"?><\/span>/i, "").replace(/<span class="?textarea"?><textarea><\/textarea><\/span>/i, ""))
            ...
            case"write":
                if (arguments.length > 1)return this.each(function () {
                    var e = Z(this).attr(tt), n = e && u[e], r = n && n.cursor;
                    r && r.writeLatex(t).parent.blur()
                });
            case"cmd":
                if (arguments.length > 1)return this.each(function () {
                    var e, n = Z(this).attr(tt), r = n && u[n], i = r && r.cursor;
