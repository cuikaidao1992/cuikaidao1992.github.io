...
!function (a) {
    ...
    var key = function () {
        ...
        for (var o = this.beforeCommand = function () {
                ...
                n.recordUndo(), b || a.triggerEvent("change", e.html())
                 ...
                 q = ["bold", "italic", "underline", "strikethrough", "superscript", "subscript", "justifyLeft", "justifyCenter", "justifyRight", "justifyFull", "formatBlock", "removeFormat", "backColor", "foreColor", "fontName"],
                 r = 0, s = q.length; r < s; r++)this[q[r]] = function (a) {
            return function (b) {
        ...
        this.events = {
            ...
            if (dom.isImg(b)) {
                for (var c = b.src, d = atob(c.split(",")[1]), e = new Uint8Array(d.length),
                         f = 0; f < d.length; f++)e[f] = d.charCodeAt(f);
    ...
    var Codeview = function (a) {
        ...
        this.initialize = function () {
            ...
            for (var e = 0, f = d.length; e < f; e++) {
                for (var g = d[e], h = g[0], i = g[1], j = c.buttonGroup({className: "note-" + h}).render(), k = 0,
                         l = i.length; k < l; k++) {
        ...
        this.initialize = function () {
            ...
            var b,
                c = a.match(/^(?:https?:\/\/)?(?:www\.)?(?:youtu\.be\/|youtube\.com\/(?:embed\/|v\/|watch\?v=|watch\?.+&v=))((\w|-){11})(?:\S+)?$/),
                ...
                h = a.match(/\/\/v\.youku\.com\/v_show\/id_(\w+)=*\.html/), i = a.match(/^.+.(mp4|m4v)$/),
                j = a.match(/^.+.(ogg|ogv)$/), k = a.match(/^.+.(webm)$/);
            if (c && 11 === c[1].length) {
                var l = c[1];
        ...
        this.createShortCutList = function () {
            ...
            this.$dialog = c.dialog({
                ...
                footer: b,
                callback: function (a) {
                    a.find(".modal-body").css({"max-height": 300, "overflow-y": "scroll"})
                }
            }).render().appendTo(a)
        }, this.destroy = function () {
            c.hideDialog(this.$dialog), this.$dialog.remove()
    ...
    $.summernote = $.extend($.summernote, {
        ...
        options: {
            ...
            fontNames: ['宋体','黑体','楷体','微软雅黑','Arial', 'Arial Black', 'Comic Sans MS', 'Courier New', "Helvetica Neue", "Helvetica", "Impact", "Lucida Grande", "Times New Roman"],
